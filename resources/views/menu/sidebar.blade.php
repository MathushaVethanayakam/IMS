...
<div class="container1">
    ...
    <div class="part1"><h4><b>Inventory Management System</b></h4><h6>Department of Chemistry UOJ</h6></div>

    <div class="part2">   
    <span style="color: white; font-size: 16px;">{{ $user->fullname }}</span> 
        <a href="#" onclick="openProfileModal()">
            <i class="fa fa-user-circle " style="color:white; font-size: 35px; margin-top:20px; margin-left:5px;"></i></a>
    ...
    <nav class="main-menu">
        ...
        <ul>
            <li>
                <a href="{{url('/ho')}}" onclick="loadSection('home')">
            ...
            <li>
                <a href="{{url('/chemical')}}" onclick="loadSection('chemical')">
                    <i class="	fas fa-vial nav-icon"></i>
                    <span class="nav-text">Chemicals</span>
                </a>
            </li>
            <li>
                <a href="{{url('/instruments')}}" onclick="loadSection('instruments')">
                    <i class="fa fa-flask nav-icon"></i>
                    <span class="nav-text">Equipments</span>
                </a>
            </li>
            <li>
                <a href="{{url('/br-index3')}}"onclick="loadSection('broken')">
            ...
            <li>
                <a href="#" onclick="loadSection('notification')">
