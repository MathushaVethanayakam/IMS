...
<div class="container1">
    ...
    <nav class="main-menu">
        ...
        <ul>
            <li>
                <a href="{{url('/lhome')}}" onclick="loadSection('home')">
            ...
            <li>
                <a href="{{url('/chemical2')}}" onclick="loadSection('chemical2')">
                    <i class="fas fa-vial nav-icon"></i>
                    <span class="nav-text">Chemicals</span>
                </a>
            </li>
            <li>
                <a href="{{url('/ins-index3')}}" onclick="loadSection('instruments')">
                    <i class="fa fa-flask nav-icon"></i>
                    <span class="nav-text">Equipments</span>
                </a>
            </li>
            <li>
                <a href="{{url('/broken_glass')}}"onclick="loadSection('broken')">
