...
<div class="centered-container">
    <div class="container-fluid form-container">
            ...
            <h4 style="text-align:center; padding:10px;">Create Organic Chemical</h4>
            @if ($errors->any())
            ...
            <form method="POST" action="{{ route('organic_chemicals.store') }}">
            @csrf
            ...
            <div class="btn-container">
                <button type="submit" class="btn btn-primary">Create Organic Chemical</button>
            </div>
        </form>
    </div>
</div>
