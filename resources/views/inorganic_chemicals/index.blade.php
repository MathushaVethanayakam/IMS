        ...
        <div class="card-container">
            ...
            <div class="inorganic-container">
                ...
                <div class="new-container">
                    <a href="{{ route('inorganic_chemicals.create') }}" style="text-decoration: none; color: white; font-size:12px;" data-bs-toggle="tooltip"  title="Add New Inoraganic Chemical">+ New Chemical</a>
                </div>
            </div>
                    ...
                    <table class="table table-hover table-borderless">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('inorganic_chemicals.edit', $chemical->id) }}" class="btn btn-primary btn-sm" data-bs-toggle="tooltip"  title="Edit">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <form method="POST" action="{{ route('inorganic_chemicals.destroy', $chemical->id) }}" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
